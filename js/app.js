...
export const AppState = {
  ...
  colors: {
    ...
    teeBox:     'rgba(179, 214, 146, 1)',
    green:      'rgba(170, 237, 90, 1)',
	rough:      'rgba(199, 209, 151, 1)',
    background: 'rgba(0, 0, 0, 0)',
    water:      'rgba(151, 217, 215, 1)',
    sand:       'rgba(251, 246, 191, 1)',
...
const COLOR_CONFIG = [
  ...
  { el: 'color-background', key: 'background' }, // ADD THIS LINE
...
const PRESETS = {
  ...
  original: { // The original bright green solid style
    ...
    rough:      'rgba(40, 200, 75, 1)',
    background: 'rgba(24, 187, 62, 1)',
